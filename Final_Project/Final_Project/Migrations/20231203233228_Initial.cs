    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 12, 3, 18, 32, 27, 503, DateTimeKind.Local).AddTicks(6072), "Mexican", "Grilled meat and veggies in a flour shell", "Tacos" },
                    { 2, new DateTime(2023, 12, 3, 18, 32, 27, 503, DateTimeKind.Local).AddTicks(6121), "French", "Delicious form of cut potatos", "French Fries" },
                    { 4, new DateTime(2023, 12, 3, 18, 32, 27, 503, DateTimeKind.Local).AddTicks(6124), "Italian", "Pasta + chicken = bussin", "Chicken Alfredo" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 12, 3, 18, 32, 27, 503, DateTimeKind.Local).AddTicks(6146), "Staying fit ", "Working out" },
                    { 2, new DateTime(2023, 12, 3, 18, 32, 27, 503, DateTimeKind.Local).AddTicks(6149), "Enjoying the way imagination runs wild", "Art" }
                });
